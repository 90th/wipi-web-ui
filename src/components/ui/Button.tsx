...
export default function Button({class: userClassAttr, children, ...rest}: JSX.IntrinsicElements["button"]) {
  ...
  sigma:bg-sigma-bright sigma:text-sigma-faint sigma:font-bold sigma:hover:text-sigma-bright sigma:hover:bg-sigma-faint sigma:focus:ring-0 sigma:focus:ring-offset-2 sigma:focus:ring-offset-sigma-bright
