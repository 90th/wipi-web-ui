...
export function Card({ class: userClass, classList: userClassList, children, ...rest }: JSX.IntrinsicElements["div"]) {
  const classAttr = `
    rounded-xl border border-gray-200 bg-white text-slate-950 shadow-sm transition-colors duration-200
    dark:border-gray-800 dark:bg-gray-900 dark:text-slate-50
